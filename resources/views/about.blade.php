            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="team.html" class="dropdown-item">TRANSPORT SCOLAIRE</a>
                        <a href="testimonial.html" class="dropdown-item">CAFÉTÉRIA – ICAFÉ</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="team.html" class="dropdown-item">ASSOCIATION DES PARENTS D’ÉLÈVE</a>
                        <a href="testimonial.html" class="dropdown-item">BUREAU DES ÉTUDIANTS</a>
                        <a href="404.html" class="dropdown-item">Fournitures Scolaires 2022 – 2023</a>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">A propos de Learn.</h1>
