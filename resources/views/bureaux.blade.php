...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="{{url('bureaux')}}" class="dropdown-item">BUREAUX DES ÉTUDIANTS</a>
    ...
    <div class="container-fluid bg-primary py-5 mb-5 page-header-clubs">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">BUREAUX DES ÉTUDIANTS</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">EXTRA</a></li>
                            <li class="breadcrumb-item text-white " aria-current="page">BUREAUX DES ETUDIANTS</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">CLUBS</h1>
            </div>
            <div class="row g-3">
                <div class="col-lg-7 col-md-6">
                    <div class="row g-3">
                    <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="scientifique">
                                <img class="img-fluid" src="img/club1.png" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="img/club3.png" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                                    <h5 class="m-0">culturel </h5>
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="img/club5.png" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                                    <h5 class="m-0">Artistique</h5>
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="img/club4.png" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                                    <h5 class="m-0">Sportifs </h5>
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="img/club2.png" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                                    <h5 class="m-0">Bénévole </h5>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" id="scientigique">Scientifique </h1>
                    <p class="mb-4">
                    ce club représente le coté vert de l’école en incitant à la protection de la terre, la création des espaces verts, activités de recyclage et autres.</p>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">culturel </h1>
                    <p class="mb-4">
                    Ce club sert à développer la culture général chez nos lycéens, à développer leur capacité rédactionnelle, communicationnelle et de conviction via des débats, compétitions de rédaction et prise de parole en public.
</p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                   ...
                   <h1 class="mb-4">Artistique </h1>
                   <p class="mb-4">
                   Ce club aide les inscrits au club à exprimer leur talents et se découvrir eux même et surtout partager leur dons avec leur entourage scolaire.
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Sportif </h1>
                    <p class="mb-4">
                    Ce club a pour objectif l’épanouissement physique des élèves et le développement de l’esprit de compétitivité et le travail d’équipe.</p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                   ...
                   <h1 class="mb-4" id="">Benevole </h1>
                   <p class="mb-4">
                   Ce club est l’un des clubs les plus important, il permet de sensibiliser les élèves quant à l’aide, l’humanisme et le partage. Aussi, il permet de prendre conscience des gens en besoin et en situations difficile.</p>  
